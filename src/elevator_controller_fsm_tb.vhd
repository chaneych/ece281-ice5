...
--|
--| DOCUMENTATION : For this assignment, I did not use any outside resources. All instructions
--| came from the the ICE 5 GitHub page.
--|
--+----------------------------------------------------------------------------
--|
--| REQUIRED FILES :
...
begin
	...
	begin
        ...
        wait for k_clk_period * 3;
            assert w_floor = x"1" report "bad down to floor 1" severity failure;
        wait for k_clk_period * 2;
            assert w_floor = x"1" report "bad stop at floor 1" severity failure;		  	
		wait; -- wait forever
	end process;	
	-----------------------------------------------------	
